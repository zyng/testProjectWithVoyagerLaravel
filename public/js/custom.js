$(document).ready(function(){
    ...
    $('.c-iconpicker').iconpicker({
        //...
        title: 'Wybierz ikone',
            icons: [
            {
                    title: "icon-thermometer31",
                ...
                {
                    title: "icon-unhealthy",
                    searchTerms: ["unhealthy"]
                },
                {
                    title: "icon-united8",
                    searchTerms: ["united"]
                ...
                {
                    title: "icon-bacteria4",
                    searchTerms: ["bacteria"]
                },
                {
                    title: "icon-balance14",
                    searchTerms: ["balance"]
                },
                {
                    title: "icon-bandaid2",
                ...
                {
                    title: "icon-cardiogram1",
                    searchTerms: ["cardiogram"]
                },
                {
                    title: "icon-chemistry1",
                    searchTerms: ["chemistry"]
                },
                {
                    title: "icon-clipboard9",
                    searchTerms: ["clipboard"]
                },
                {
                    title: "icon-clipboards3",
                    searchTerms: ["clipboards"]
                },
                {
                    title: "icon-cross28",
                    searchTerms: ["cross"]
                ...
                {
                    title: "icon-disability5",
                    searchTerms: ["disability"]
                },
                {
                    title: "icon-dna20",
                    searchTerms: ["dna"]
                ...
                {
                    title: "icon-droppers1",
                    searchTerms: ["droppers"]
                },
                {
                    title: "icon-drug7",
                    searchTerms: ["drug"]
                ...
                {
                    title: "icon-gynecology",
                    searchTerms: ["gynecology"]
                },
                {
                    title: "icon-hammers5",
                    searchTerms: ["hammers"]
                ...
                {
                    title: "icon-helicopter2",
                    searchTerms: ["helicopter"]
                },
                {
                    title: "icon-hospital35",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital36",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital37",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital38",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital39",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital40",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospitals",
                    searchTerms: ["hospitals"]
                },
                {
                    title: "icon-hospitals1",
                    searchTerms: ["hospitals"]
                },
                {
                    title: "icon-hospitals2",
                    searchTerms: ["hospitals"]
                },
                {
                    title: "icon-human3",
                ...
                {
                    title: "icon-injection5",
                    searchTerms: ["injection"]
                },
                {
                    title: "icon-lace1",
                    searchTerms: ["lace"]
                ...
                {
                    title: "icon-operation4",
                    searchTerms: ["operation"]
                },
                {
                    title: "icon-pharmacy1",
                ...
                {
                    title: "icon-pregnant",
                    searchTerms: ["pregnant"]
                },
                {
                    title: "icon-science47",
                    searchTerms: ["science"]
                },
                {
                    title: "icon-scissors7",
                    searchTerms: ["scissors"]
                },
                {
                    title: "icon-skeleton7",
                    searchTerms: ["skeleton"]
                },
                {
                    title: "icon-surgery",
                    searchTerms: ["surgery"]
                ...
                {
                    title: "icon-telephonecall3",
                    searchTerms: ["telephone"]
                },
                {
                    title: "icon-testtube5",
                    searchTerms: ["testtube"]
                },
                {
                    title: "icon-textlines5",
                    searchTerms: ["textline"]
                },
                {
                    title: "icon-thermometer15",
                    searchTerms: ["thermometer"]
                },
                {
                    title: "icon-toothpaste2",
                    searchTerms: ["toothpaste"]
                },
                {
                    title: "icon-transport66",
                    searchTerms: ["transport"]
                },
                {
                    title: "icon-urology",
                    searchTerms: ["urology"]
            ...
            },
            {
                ...
                {
                title: "flaticon-shield",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-wheelchair",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-first-aid-kit",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-doctor",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-nurse",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-vaccine",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-stethoscope",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-medical-result",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-heart",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-blood-donation",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-massage",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-depilation",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-massage-1",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-cream",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-stones",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-essential-oil",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-stones-1",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-treatments",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-massage-2",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-spa",
                ...
                {
                title: "flaticon-cream-1",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-spa-1",
                searchTerms: ['medical']
            },
                {
                title: "flaticon-spa-2",
                searchTerms: ['medical']
            },
                {
                ...
                {
                    title: "flaticon-facebook-logo",
                    searchTerms: ['contact']
                },
                {
                    title: "flaticon-instagram",
                    searchTerms: ['contact']
                },
               {
                title: "fab fa-500px",
                ...
                {
                    title: "icon-chromosome",
                    searchTerms: ["chromosome"]
                },
                {
                    title: "icon-drops1",
                    searchTerms: ["drops"]
                ...
                {
                    title: "icon-medical14",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medicine13",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-medicine14",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-medicine15",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-medicine16",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-medicine17",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-pill",
                ...
                {
                    title: "icon-thermometer23",
                    searchTerms: ["thermometer"]
                },
                {
                    title: "icon-ambulance14",
                    searchTerms: ["ambulance"]
                },
                {
                    title: "icon-baby137",
                ...
                {
                    title: "icon-caduceus3",
                    searchTerms: ["caduceus"]
                },
                {
                    title: "icon-cells",
                    searchTerms: ["cells"]
                ...
                {
                    title: "icon-handicap2",
                    searchTerms: ["handicap"]
                },
                {
                    title: "icon-heart254",
                    searchTerms: ["heart"]
                ...
                {
                    title: "icon-hospital14",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital15",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital16",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital17",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-hospital18",
                    searchTerms: ["hospital"]
                },
                {
                    title: "icon-human88",
                ...
                {
                    title: "icon-lifeline9",
                    searchTerms: ["lifeline"]
                },
                {
                    title: "icon-lungs4",
                    searchTerms: ["lungs"]
                ...
                {
                    title: "icon-medical45",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical46",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical47",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical48",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical49",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical50",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical51",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical52",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical53",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical54",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medical55",
                    searchTerms: ["medical"]
                },
                {
                    title: "icon-medicine30",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-medicine31",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-medicines4",
                    searchTerms: ["medicine"]
                },
                {
                    title: "icon-men15",
                ...
                {
                    title: "icon-negative12",
                    searchTerms: ["negative"]
                },
                {
                    title: "icon-nurse6",
                    searchTerms: ["nurse"]
                ...
                {
                    title: "icon-person278",
                    searchTerms: ["person"]
                },
                {
                    title: "icon-pharmacy7",
                    searchTerms: ["pharmacy"]
                },
                {
                    title: "icon-pharmacy8",
                    searchTerms: ["pharmacy"]
                },
                {
                    title: "icon-pharmacy9",
                    searchTerms: ["pharmacy"]
                },
                {
                    title: "icon-poison2",
                ...
                {
                    title: "icon-positive3",
                    searchTerms: ["positive"]
                },
                {
                    title: "icon-pregnancy",
                    searchTerms: ["pregnancy"]
                },
                {
                    title: "icon-pulse1",
                    searchTerms: ["pulse"]
...
function stickyMenu() {
    jQuery(function ($) {
        var scrollingStartDistance = $(".c-down-menu-container").offset().top;

        $(document).scroll(function () {
            var scrollTop = $(document).scrollTop();

            $(".c-down-menu-container").toggleClass("scrolling", scrollTop > scrollingStartDistance);
        });
    });
}
...
function checkFormBody() {
    $(".c-footer-form-textarea").blur(function () {
        if($(this).val().length == 0)
        {
            $(this).removeClass("c-valid").addClass("c-invalid");
            $(".c-error-message").css({"display":"block"});
        }else{
            $(this).removeClass("c-invalid").addClass("c-valid");
            $(".c-error-message").css({"display":"none"});
        }
        activeContactForm();
    })
}
...
function activeContactForm() {
    ...
    var pattern = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;
    if ($(".c-footer-form-textarea").val().length == 0 || $(".c-form-input-name").val().length == 0 || !pattern.test($(".c-form-input-email").val())) {
...
function checkRecaptcha() {
    ...
    $('#c-footer-form').submit(function (e) {
        var response = grecaptcha.getResponse();
        e.preventDefault();

        if(response.length != 0)
            {
                $(".c-error-recaptcha").css({"display":"block"});
                return false;
            }else{
                $(".c-error-recaptcha").css({"display":"none"});
                return true;
        }
    })
}
