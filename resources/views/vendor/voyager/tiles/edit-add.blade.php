                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @if($limit && $row->display_name === "Opublikowane" && !$active)
                                    <span style="color: red;" for="name">Limit (6) elementów wyświetlanych na stronie wyczerpany. Aby opublikować element na stronie musisz najpierw zdeaktywować, któryś z aktywnych elementów.</span>
                                @else
