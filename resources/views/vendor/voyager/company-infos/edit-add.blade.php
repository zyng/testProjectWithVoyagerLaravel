                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @else
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ isset($display_options->width) ? $display_options->width : 12 }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        {{ $row->slugify }}
                                        <label for="name">{{ $row->display_name }} @if($row->display_name === "Facebook") <span>Przykładowo: https://www.facebook.com/</span> @elseif($row->display_name === "Google+")<span>Przykładowo: https://www.google.com/</span> @endif</label>
